class Aux4 < Formula
  ...
  if OS.mac?
    if Hardware::CPU.intel?
      url "https://github.com/aux4/aux4/releases/download/v5.0.1/aux4-darwin-amd64"
    ...
    if Hardware::CPU.intel?
      url "https://github.com/aux4/aux4/releases/download/v5.0.1/aux4-linux-amd64"
    ...
    if Hardware::CPU.intel?
      ...
      url "https://github.com/aux4/aux4/releases/download/v5.0.1/aux4-windows-386.exe"
